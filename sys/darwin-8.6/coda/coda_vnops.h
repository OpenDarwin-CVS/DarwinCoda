...
int coda_pagein(void *);
int coda_advlock(void *);

int coda_rdwr(struct vnode *vp, struct uio *uiop, enum uio_rw rw,
    int ioflag, vfs_context_t vfsctx);
int coda_grab_vnode(dev_t dev, ino_t ino, struct vnode **vpp, vfs_context_t vfsctx);
void print_vattr(struct vnode_attr *attr);
